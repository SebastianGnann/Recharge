...
plotting_fcts.plot_lines_group(df_ERA5["aridity_netrad"], 1-df_ERA5["e"]/df_ERA5["tp"], "#CEA97C", n=11, label='ET ERA5', statistic=stat)
...
#plotting_fcts.plot_lines_group(df_Caravan["aridity_netrad"], 1-(1-df_Caravan["BFI"])*df_Caravan["TotalRR"], "#947351", n=11, label='P-Qf Caravan', statistic=stat)
...
#im = axes.scatter(df_Caravan["aridity_netrad"], df_Caravan["TotalRR"], s=2.5, c="#a6cee3", alpha=0.25, lw=0)
#plotting_fcts.plot_lines_group(df_Caravan["aridity_netrad"], df_Caravan["TotalRR"], "#a6cee3", n=11, label='Q Caravan', statistic=stat)
im = axes.scatter(df_Caravan2["aridity_netrad"], df_Caravan2["TotalRR"], s=2.5, c="#a6cee3", alpha=0.25, lw=0)
plotting_fcts.plot_lines_group(df_Caravan2["aridity_netrad"], df_Caravan2["TotalRR"], "#a6cee3", n=11, label='Q Caravan', statistic=stat)
...
print("Aridity and recharge")
fig = plt.figure(figsize=(3, 2.75), constrained_layout=True)
axes = plt.axes()
im = axes.scatter(df_Moeck["aridity_netrad"], df_Moeck["recharge"], s=10, c="skyblue", alpha=0.1, lw=0)
im = axes.scatter(df_MacDonald["aridity_netrad"], df_MacDonald["recharge"], s=10, c="tab:blue", alpha=0.9, lw=0)
im = axes.scatter(df_Hartmann["aridity_netrad"], df_Hartmann["recharge"], s=10, c="tab:orange", alpha=0.9, lw=0)
plotting_fcts.plot_lines_group(df_Moeck["aridity_netrad"], df_Moeck["recharge"], "skyblue", n=11, label='Moeck', statistic=stat)
plotting_fcts.plot_lines_group(df_MacDonald["aridity_netrad"], df_MacDonald["recharge"], "tab:blue", n=6, label='MacDonald', statistic=stat)
plotting_fcts.plot_lines_group(df_Hartmann["aridity_netrad"], df_Hartmann["recharge"], "tab:orange", n=6, label='Hartmann', statistic=stat)
axes.set_xlabel("PET/P")
axes.set_ylabel("Recharge [mm/yr]")
axes.set_xlim([0.1, 5])
axes.set_ylim([0.1, 2000])
...
axes.set_yscale('log')
#plotting_fcts.plot_grid(axes)
fig.savefig(figures_path + "aridity_recharge.png", dpi=600, bbox_inches='tight')
plt.close()
