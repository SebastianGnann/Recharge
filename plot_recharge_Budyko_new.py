...
plotting_fcts.plot_lines_group(df_Lee["aridity_netrad"], df_Lee["recharge_ratio"], "darkgrey", n=11, label='Lee', statistic=stat, uncertainty=True)
plotting_fcts.plot_lines_group(df_Moeck["aridity_netrad"], df_Moeck["recharge_ratio"], "dimgrey", n=11, label='Moeck', statistic=stat, uncertainty=True)
plotting_fcts.plot_lines_group(df_MacDonald["aridity_netrad"], df_MacDonald["recharge_ratio"], "black", n=11, label='MacDonald', statistic=stat, uncertainty=True)
#im = axes.plot(np.linspace(0.1,10,1000), Berghuijs_recharge_curve(np.linspace(0.1,10,1000)), "-", c="grey", alpha=0.75, label='Berghuijs')
plotting_fcts.plot_lines_group(df_BB["PET"]/df_BB["P"], df_BB["Qb"]/df_BB["P"], "#073763", n=11, label='Q_b', statistic=stat, uncertainty=True)
...
fig.savefig(figures_path + "Budyko_recharge_alt_new.png", dpi=600, bbox_inches='tight')
plt.close()
...
plotting_fcts.plot_lines_group(df_MacDonald["aridity_netrad"], df_MacDonald["recharge_ratio"], "#704b5b", n=11, label='MacDonald', statistic=stat)
...
#plotting_fcts.plot_lines_group(df_Caravan["aridity_netrad"], df_Caravan["TotalRR"], "#a6cee3", n=11, label='Q Caravan', statistic=stat)
im = axes.scatter(df_Caravan2["aridity_netrad"], df_Caravan2["TotalRR"], s=2.5, c="tab:blue", alpha=0.75, lw=0)
...
im = axes.scatter(df_CAMELS["aridity"], df_CAMELS["runoff_ratio"], s=2.5, c="tab:purple", alpha=0.75, lw=0)
plotting_fcts.plot_lines_group(df_CAMELS["aridity"], df_CAMELS["runoff_ratio"], "tab:purple", n=11, label='Q CAMELS', statistic=stat)
im = axes.plot(np.linspace(0.1,10,100), 1-Budyko_curve(np.linspace(0.1,10,100)), "-", c="black", alpha=0.75, label="Budyko Q")
axes.set_xlabel("Climatic aridity (Ep/P) [-]")
axes.set_ylabel("Runoff ratio (Q/P) [-]")
axes.set_xlim([0.2, 5])
axes.set_ylim([-0.0, 1.2])
#axes.legend(loc='center right', bbox_to_anchor=(1.4, 0.5))
axes.set_xscale('log')
axes.hlines(1, 0.2, 5, color="grey", linestyle="--")
#plotting_fcts.plot_grid(axes)
fig.savefig(figures_path + "Budyko_standard_new.png", dpi=600, bbox_inches='tight')
plt.close()
...
plotting_fcts.plot_lines_group(df_MacDonald["aridity_netrad"], df_MacDonald["recharge_ratio"], "#704b5b", n=11, label='MacDonald', statistic=stat, uncertainty=True)
plotting_fcts.plot_lines_group(df_Lee["aridity_netrad"], df_Lee["recharge_ratio"], "#977173", n=11, label='Lee', statistic=stat, uncertainty=True)
#plotting_fcts.plot_lines_group(df_Hartmann["aridity_netrad"], df_Hartmann["recharge_ratio"], "#e8cbe0", n=11, label='Hartmann', statistic=stat, uncertainty=True)
axes.set_xlabel("PET / P [-]")
axes.set_ylabel("Flux / P [-]")
axes.set_xlim([0.2, 5])
axes.set_ylim([-0.1, 1.1])
